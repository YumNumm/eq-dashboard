...
class _GdEewApiClient implements GdEewApiClient {
  _GdEewApiClient(
    this._dio, {
    this.baseUrl,
    this.errorLogger,
  ...
  Future<EewListResponse> getEewList({
    ...
    final _options = _setStreamType<EewListResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<EewEventResponse> getEewEvent(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late EewEventResponse _value;
    try {
      _value = EewEventResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
